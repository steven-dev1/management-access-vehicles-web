        ...
        <CardContent className="p-4">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            ...
            <select
              ...
              className="flex h-8 items-center rounded-lg border border-[#374151] bg-[#1A1A1A] px-3 py-1 text-sm text-white"
            >
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {vehicles.map((v) => (
                    <TableRow key={v.id} className="border-[#374151] hover:bg-[#1A1A1A]/50">
